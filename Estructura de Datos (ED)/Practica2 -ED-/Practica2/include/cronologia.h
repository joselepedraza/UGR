...
string concatenarFechas()const;
	...
	public:
		typedef vector<fechahistorica>::iterator iterator;
		typedef vector<fechahistorica>::const_iterator const_iterator;
		 ...
		 * @param fechas [Tipo vector<fechahistorica> ]
		 */
		cronologia(const vector<fechahistorica> &fechas);
		...
		*/
		 ...
		 */
		vector<fechahistorica> getFechas()const;

		/**
		 * @brief Modifica el conjunto completo de fechas de una cronologia
		 * @param anio [Tipo int] Nuevo vector de tipo fechahistorica
		 */
		void setFechas(vector<fechahistorica>& v);
		...
		*/
		...
		/**
		 * @brief Ordena las fechas de menor a mayor
		 * @return void
		*/
		void ordenar();
