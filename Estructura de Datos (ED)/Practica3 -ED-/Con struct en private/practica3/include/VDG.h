...
/*______________________________________________________________________*/  
  /**
     Constructor: crea un vector dinámico.
     @doc
       Crear un vector dinámico por defecto.
    */
  VectorDinamico(){}
  
  /**
   Constructor por copia: crea un vector dinámico copiando otro
   * @param vd: objeto vector dinámico
     @doc
       Crear un vector dinámico copiando otro pasado por param.
   */
  VectorDinamico(const VectorDinamico<T> &vd);
  
  
  /**
   * @param objeto de tipo vector dinámico
   * @doc Operador de asignacion
   * */
  VectorDinamico& operator= (const VectorDinamico<T>& vd);
/*______________________________________________________________________*/
