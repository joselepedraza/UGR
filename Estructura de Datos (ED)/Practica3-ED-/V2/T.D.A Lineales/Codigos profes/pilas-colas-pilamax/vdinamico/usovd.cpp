...
int main()
{
  ...
  cout << "1 Máximo de "<< vec.size() << " elementos: " << maximo(vec) << endl;
  cout << "2 Máximo de "<< vec1.size() << " elementos: " << maximo(vec1) << endl;
  cout << "3 Máximo de "<< vec2.size() << " elementos: " << maximo(vec2) << endl;
  return 0; 
}
