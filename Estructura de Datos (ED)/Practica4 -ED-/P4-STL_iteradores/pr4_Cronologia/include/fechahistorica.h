...
class fechahistorica{
	...
	private:
		pair<int,set<string>> contenedor_fh;
		
		
		//Lo podremos hacer asi ?
		/*int anio;
	...
	public:
		...
		*/
		 ...
		 * @param par de entero [anio] y set de string [acontecimientos]
		 */
		fechahistorica(pair<int,set<string>>& fh);
		...
		/**
		 * @brief Constructor con parametros
		 * @param an [Tipo int] anio de los acontecimientos
		 * @param s [set<string>] cadenas que describen un anio
		 */
		fechahistorica(int an, set<string> s);
		...
		*/
		 ...
		 * @return void
		 */
		void setAcontecimientos(const set<string> &s);
		...
		*/
		...
		/**
		 * @brief Aniade un acontecimiento en la fecha
		 * @param str tipo set<string>, acontecimientos a introducir
		 * @return void
		*/
		void aniadirAcontecimientos(set<string> str);
