...
int producir_dato(int num_prod)
{
   ...
   for(int i = iprod[num_prod]; i < num_items/num_hebras; i++){
     cont_prod[contador] ++ ;
     contador++;
...
{
   for( unsigned i = 0 ; i < num_items ; i++ ) //cada productor produce num_items/num_hebras
   {
...
{
   for( unsigned i = 0 ; i < num_items; i++ ) //cada consumidor consume num_items/num_hebras
   {
...
{
   cout << "-------------------------------------------------------------------------------" << endl
        << "Problema de varios productores-consumidores (Varios prod/cons, Monitor SC, buffer LIFO). " << endl
        << "-------------------------------------------------------------------------------" << endl
        << flush ;
      ...
      for(int i=0; i<num_hebras;i++){//inicializamos las 5 hebras
