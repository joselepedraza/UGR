...
void funcion_hebra_3( int n ) { resultado1 = factorial( n ) ; }

int main()
{
  // iniciar las hebras
  thread hebra1( funcion_hebra_1, 50),// calcula factorial(5) en resultado1
         hebra2( funcion_hebra_2, 10 ), // calcula factorial(10) en resultado2
	hebra3( funcion_hebra_3, 30 );

  // esperar a que terminen las hebras,
  hebra1.join() ; hebra2.join(); hebra3.join();

  // imprimir los resultads:
  cout << "factorial(50)  == " << resultado1 << endl
       << "factorial(10) == " << resultado2 << endl 
	<< "factorial(30) == " << resultado1 << endl; 
}
