...
void funcion_hebra_estanquero(  ){
	...
	while(true){ 	//no para de producir
		if(cont_exist == 0){	//si no tiene mas ingredientes, cierra el estanco		
			cout << "\tEL ESTANCO HA CERRADO." << endl;
			//sem_signal(fuma[ingrediente]);
			break;
		}
