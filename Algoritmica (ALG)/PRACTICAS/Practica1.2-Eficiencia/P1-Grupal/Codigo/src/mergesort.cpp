...
/**
   @brief Ordena un vector por el metodo de mezcla.
...
/**
   @brief Ordena parte de un vector por el metodo de mezcla.
...
/**
   ...
   inicial y final - 1 de forma que los dispone en sentido creciente
   de menor a mayor.
   Aplica el algoritmo de la insercion.
*/
