...
{	
	...
	switch (toupper(Tecla1)){
		...
		case 'W': flexo.velocidad_brazo1_Z+=1.0;break;
		case 'E': flexo.velocidad_brazo1_Z-=1.0;
			if(flexo.velocidad_brazo1_Z < 0){
				flexo.velocidad_brazo1_Z = 1.0;
			}
			break;
		case 'R': flexo.velocidad_brazo2_Z+=1.0; break;
		case 'T': flexo.velocidad_brazo2_Z-=1.0;
			if(flexo.velocidad_brazo2_Z < 0){
				flexo.velocidad_brazo2_Z = 1.0;
			}
			break;
		case 'U': flexo.velocidad_cabeza_X+=1.0; break;
		case 'I': flexo.velocidad_cabeza_X-=1.0;
			if(flexo.velocidad_cabeza_X < 0){
				flexo.velocidad_cabeza_X = 1.0;
			}
			break;
...
switch (Tecla1){
	...
	case GLUT_KEY_F11: flexo.velocidad_brazo1_Y+=0.5;break;
	case GLUT_KEY_F12:
		flexo.velocidad_brazo1_Y-=0.5;
