...
{	//TAMBIÉN SE PUEDE COLOCAR EN CADA OBJETO
	//Coeficientes para Reflexion Especular (mas difusa y ambiente) - color unico para todos los objetos
	
	calculadas_normales_caras=false;
	calculadas_normales_vertices=false;

	//Esto podriamos ponerlo en el constructor de cada figura
	//Plateado
	/*ambiente=_vertex4f(0.19225,0.19225,0.19225,1.0);	valor bajo siempre para que no sature
