...
void _perfil_PLY::leer_perfil(char *archivo){
  ...
  int j = 0;
  //iluminación correcta pero inversa a la figura por como se pintan las caras
  ...
  */
  //para iluminación correcta (pintar inversamente, peón "hueco")
  for(unsigned int i = ver_ply.size(); i > 0; i-=3){
    perfil[j].x = ver_ply[i-1];
    perfil[j].y = ver_ply[i-2];
    perfil[j].z = ver_ply[i-3];
...
void _chasis::draw(_modo modo,_material m, float r1, float g1, float b1, float r2, float g2, float b2, float grosor)
{
  glPushMatrix();
  glScalef(1.0,0.22,0.95);
  base.draw(modo,m, r1, g1, b1, r2, g2, b2, grosor);
  glPopMatrix();

  glPushMatrix();
  glRotatef(90.0,1,0,0);
  rodamiento.draw(modo,m, r1, g1, b1, r2, g2, b2, grosor);
  glPopMatrix();
...
void _torreta::draw(_modo modo,_material m, float r1, float g1, float b1, float r2, float g2, float b2, float grosor)
{
  glPushMatrix();
  ...
  parte_trasera.draw(modo, m, r1, g1, b1, r2, g2, b2, grosor);
  glPopMatrix();
}
...
void _tubo::draw(_modo modo, _material m, float r1, float g1, float b1, float r2, float g2, float b2, float grosor)
{
  glPushMatrix();
  glTranslatef(0.4,0,0);
  glRotatef(90.0,0,0,1);
  tubo_abierto.draw(modo,m, r1, g1, b1, r2, g2, b2, grosor);
  glPopMatrix();
}
...
void _tanque::draw(_modo modo,_material m, float r1, float g1, float b1, float r2, float g2, float b2, float grosor)
{
  glPushMatrix();

  if(activo[0]==1){
    chasis.draw(modo,m, r_sel, g_sel, b_sel, r2, g2, b2, grosor);
  }
  else{
    chasis.draw(modo,m, r1, g1, b1, r2, g2, b2, grosor);
  }
  glRotatef(giro_torreta,0,1,0);
    ...
    if(activo[1]==1){
      torreta.draw(modo,m, r_sel, g_sel, b_sel, r2, g2, b2, grosor);
    }
    else{
      torreta.draw(modo,m, r1, g1, b1, r2, g2, b2, grosor);
    }
    glPopMatrix();
    ...
    if(activo[2]==1){
      tubo.draw(modo,m, r_sel, g_sel, b_sel, r2, g2, b2, grosor);
    }
    else{
      tubo.draw(modo,m, r1, g1, b1, r2, g2, b2, grosor);
    }
...
{
  glPushMatrix();
  chasis.draw(SELECT, GOLD, c, c, c, c, c, c, 1);
  c+=20;
  glRotatef(giro_torreta,0,1,0);
  glPushMatrix();
  glTranslatef(0.0,(chasis.altura+torreta.altura)/2.0,0.0);
  torreta.draw(SELECT, GOLD, c, c, c, c, c, c, 1);
  c+=20;
  glPopMatrix();
  glPushMatrix();
  glTranslatef(torreta.anchura/2.0,(chasis.altura+torreta.altura)/2.0,0.0);
  glRotatef(giro_tubo,0,0,1);
  tubo.draw(SELECT, GOLD, c, c, c, c, c, c, 1);
  glPopMatrix();
  glPopMatrix();
}
...
_base::_base()
{
  ...
  perfil1.push_back(aux);
  soporte.parametros(perfil1,12,0,2,1);

  altura=0.2; //la del scale (para brazo1)
}

void _base::draw(_modo modo, _material m, float r1, float g1, float b1, float r2, float g2, float b2, float grosor)
{
  glPushMatrix();
  glScalef(1.2,0.5,1.0);
  pie.draw(modo, m, r1, g1, b1, r2, g2, b2, grosor);
  soporte.draw(modo, m, r1, g1, b1, r2, g2, b2, grosor);
  glPopMatrix();
...
void _brazo1::draw(_modo modo, _material m, float r1, float g1, float b1, float r2, float g2, float b2, float grosor)
{
  glPushMatrix();
  glTranslatef(0,0,-0.130);
  //glRotatef(45.0,0,0,1);
  tubo_cerrado.draw(modo, m, r1, g1, b1, r2, g2, b2, grosor);
  glPopMatrix();
  glPushMatrix();
  glTranslatef(0,0,0.130);
  //glRotatef(45.0,0,0,1);
  tubo_cerrado1.draw(modo,m, r1, g1, b1, r2, g2, b2, grosor);
  glPopMatrix();
}
...
void _brazo2::draw(_modo modo, _material m, float r1, float g1, float b1, float r2, float g2, float b2, float grosor)
{
  glPushMatrix();
...
_cabeza::_cabeza()
{
  ...
  perfil.push_back(aux);
  tubo_gordo.parametros(perfil,60,0,2,1);
  altura=1.0;
...
void _cabeza::draw(_modo modo, _material m, float r1, float g1, float b1, float r2, float g2, float b2, float grosor)
{
  glPushMatrix();
  glTranslatef(-0.1,0.2,0.0);
  glPushMatrix();
  glTranslatef(2.7,-1.8,0);
  tubo_gordo.draw(modo, m, r1, g1, b1, r2, g2, b2, grosor);
  glTranslatef(0.0,0.4,0.0);
  glScalef(0.5,0.5,0.5);
  cono.draw(modo, m, r1, g1, b1, r2, g2, b2, grosor);
  glScalef(0.5,0.5,0.5);
  bombilla.draw(SOLID, m, 0.8, 0.8, 0.8, r2, g2, b2, grosor);
  glPopMatrix();
  glPopMatrix();
...
void _flexo::draw(_modo modo, _material m, float r1, float g1, float b1, float r2, float g2, float b2, float grosor)
{
  glScalef(0.5,0.5,0.5);
  glPushMatrix();
    if(activo[0]==1){
      base.draw(modo,m, r_sel, g_sel, b_sel, r2, g2, b2, grosor);
    }
    else{
      base.draw(modo,m, r1, g1, b1, r2, g2, b2, grosor);
    }
    ...
    glRotatef(45.0,0,0,1);
    if(activo[1]==1){
      brazo1.draw(modo,m, r_sel, g_sel, b_sel, r2, g2, b2, grosor);
    }
    else{
      brazo1.draw(modo,m, r1, g1, b1, r2, g2, b2, grosor);
    }
    glPushMatrix();
      glTranslatef(0.0,base.altura+brazo1.altura,0.0);
      glRotatef(giroZ_brazo2,0,0,1);
      if(activo[2]==1){
        brazo2.draw(modo,m, r_sel, g_sel, b_sel, r2, g2, b2, grosor);
      }
      else{
        brazo2.draw(modo,m, r1, g1, b1, r2, g2, b2, grosor);
      }
    
      glRotatef(giroX_cabeza,1,0,0);
      if(activo[3]==1){
        cabeza.draw(modo,m, r_sel, g_sel, b_sel, r2, g2, b2, grosor);
      }
      else{
        cabeza.draw(modo,m, r1, g1, b1, r2, g2, b2, grosor);
      }
    glPopMatrix();
...
void _flexo::seleccion(float c)
{
  glScalef(0.5,0.5,0.5);
  glPushMatrix();
  base.draw(SELECT, GOLD, c, c, c, c, c, c, 1);
  c+=20;
    glTranslatef(0.0,base.altura,0.0);
    glRotatef(giroY_brazo1,0,1,0);
    glRotatef(giroZ_brazo1,0,0,1);
    glRotatef(45.0,0,0,1);
    brazo1.draw(SELECT, GOLD, c, c, c, c, c, c, 1);
    c+=20;  

  glPushMatrix();
    glTranslatef(0.0,base.altura+brazo1.altura,0.0);
    glRotatef(giroZ_brazo2,0,0,1);
    brazo2.draw(SELECT, GOLD, c, c, c, c, c, c, 1);
    c+=20;
    
    glRotatef(giroX_cabeza,1,0,0);
    cabeza.draw(SELECT, GOLD, c, c, c, c, c, c, 1);
    c+=20;
  glPopMatrix();
  glPopMatrix();
}
