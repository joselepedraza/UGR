...
void draw_objects()
{
	switch (t_objeto){
		...
		case FLEXO: flexo.draw(modo,0.5,0.7,0.2,0.3,0.6,0.3,2);break;
	}
}
...
{	
	...
	switch (toupper(Tecla1)){
		...
		case 'W': flexo.velocidad_brazo1_Z+=0.005;break;
		case 'E': flexo.velocidad_brazo1_Z-=0.005;
			if(flexo.velocidad_brazo1_Z < 0){
				flexo.velocidad_brazo1_Z = 0.005;
			}
			break;
		case 'R': flexo.velocidad_brazo2_Z+=0.005; break;
		case 'T': flexo.velocidad_brazo2_Z-=0.005;
			if(flexo.velocidad_brazo2_Z < 0){
				flexo.velocidad_brazo2_Z = 0.005;
			}
			break;
		case 'U': flexo.velocidad_cabeza_X+=0.005; break;
		case 'I': flexo.velocidad_cabeza_X-=0.005;
			if(flexo.velocidad_cabeza_X < 0){
				flexo.velocidad_cabeza_X = 0.005;
			}
			break;
...
switch (Tecla1){
	...
	case GLUT_KEY_F11: flexo.velocidad_brazo1_Y+=0.05;break;
	case GLUT_KEY_F12:
		flexo.velocidad_brazo1_Y-=0.05;
...
// al bucle de eventos)
glutCreateWindow("PRACTICA 3 EXTRAs");
