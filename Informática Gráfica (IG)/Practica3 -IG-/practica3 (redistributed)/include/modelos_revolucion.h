...
class _flexo: public _triangulos3D
{
       public:
              ...
              float giroY_brazo1;
              float animacion_brazo1_Y = 0.1;
              float velocidad_brazo1_Y = 0.1;
              
              float giroZ_brazo1;
              float giroZ_brazo1_min;
              float giroZ_brazo1_max;
              float animacion_brazo1_Z = 0.01;
              float velocidad_brazo1_Z = 0.01;

              float giroZ_brazo2;
              float giroZ_brazo2_min;
              float giroZ_brazo2_max;
              float animacion_brazo2_Z = 0.01;
              float velocidad_brazo2_Z = 0.01;

              float giroX_cabeza;
              float giroX_cabeza_max;
              float giroX_cabeza_min;
              float animacion_cabeza_X = 0.005;
              float velocidad_cabeza_X = 0.005;
