...
<html lang="es">
	...
	<body>
		<?php
            session_start();
            require('php_PDO_POO/claseItems.php');
						...
						if ($_SESSION['usuario']=='admin'){
							echo '<aside class="registrado">
								<table border="2">
									...
									<tr><th> <a href="registro_item.php"> REGISTRAR OTRO VEHÍCULO </a> <tr><th>
								</table>
       ...
       <nav id="navigation">
		...
		<main>
            <section>
                <h2 class="tituloseccion"> VEHÍCULO AÑADIDO CORRECTAMENTE  </h2>
                <hr>
